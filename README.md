...
[PA1 Specification]: https://drive.google.com/file/d/1BNTp3I3jYEK78zK4NSdpFuXrlB6rbcGt/view?usp=share_link
...
Add the `upstream` repository remotes (you only need to do this once in your local clone):
    ...
    git remote add upstream https://github.com/cs164spring2023/pa1-chocopy-parser.git
